...
<!-- Must be changed to iterative list of listings -->
    <div class="row center mt-5">
        <div class="col-4">
            <div class="card with-3d-shadow" style="width: 20rem !important;">
                <img class="card-img card-img-overlay" src="url('https://pixabay.com/images/id-192990/')">
                <span class="badge badge-success">UploadTime</span>
                <span class="card-title">Bunglo</span>
                <div class="card-body">
        ...
        <div class="col-4">
            <div class="card" style="width: 20rem !important;">
                <img class="card-img card-img-overlay" src="url('https://pixabay.com/images/id-192990/')">
                <span class="badge badge-success">UploadTime</span>
                <span class="card-title">Bunglo</span>
                <div class="card-body">
